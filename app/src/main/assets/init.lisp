...
(ensure-directories-exist "/data/data/org.maximandroid.cas/files/")

(defun maxima::getpid () (si::getpid))
(defun maxima-getenv (a)
    (cond ((string-equal a "MAXIMA_PREFIX") *maxima-dir*)
          ((string-equal a "MAXIMA_TEMPDIR") "/data/data/org.maximandroid.cas/files/")))
...
(let ((top (pop $file_search_lisp))) 
    (push "/data/data/org.maximandroid.cas/files/additions/qepcad/qepmax/$$$.{lsp,lisp,fasl}" $file_search_lisp) 
    (push top $file_search_lisp))
(let ((top (pop $file_search_maxima))) 
    (push "/data/data/org.maximandroid.cas/files/additions/qepcad/qepmax/$$$.{mac,mc}" $file_search_maxima) 
    (push top $file_search_maxima))
...
($set_plot_option '((mlist) $gnuplot_out_file "/data/data/org.maximandroid.cas/files/maxout.html"))
...
($set_draw_defaults                                                             
   ...
   '((mequal simp) $file_name "/data/data/org.maximandroid.cas/files/maxout"))             
